...
function(t, e) {
    ...
    function r(e, n, i, d, l) {
        ...
        return e.contents().detach().each(function() {
            ...
            if (h.is(u)) e.append(h);
                ...
                a(i, d) && (s = 3 == f.nodeType ? o(h, n, i, d, l) : r(h, n, i, d, l), s || (h.detach(), s = !0)),
                s || l && l.detach()
            }
        }),
        s
    ...
    function o(e, n, r, o, d) {
        ...
        if ( - 1 == v || 1 == g.length && 0 == g[0].length) {
            ...
            c && (f = i(s(c), o), l(c, f), T && d && t(c).parent().append(d))
        } else f = i(g.slice(0, v + 1).join(p), o),
        l(c, f);
        return ! 0
    }
    function a(t, e) {
        ...
        t.fn.dotdotdot = function(e) {
            ...
            o.bind_events = function() {
                ...
                function(e, d) {
                    ...
                    "undefined" != typeof d && (("string" == typeof d || d instanceof HTMLElement) && (d = t("<div />").append(d).contents()), d instanceof t && (i = d)),
